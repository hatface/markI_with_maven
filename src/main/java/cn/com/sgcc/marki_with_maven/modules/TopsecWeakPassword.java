...
public class TopsecWeakPassword implements IPocBase {

	@Override
	public Map info() {
		// TODO Auto-generated method stub
		Map info = new HashMap<String, Object>();
		info.put("name", "TopsecWeakPassword");
		return info;
	}
	...
	public boolean match(Map infodict) {
		...
		if ( serviceVersion.toLowerCase().contains("topsec") )
		{
			ismatch = true;
		}
		return ismatch;
...
//					CloseableHttpClient customClientLocal = getCustomClient();
	...
	public static void main(String[] args) {
		...
		System.out.println(new TopsecWeakPassword().verify(infodict));
	}
