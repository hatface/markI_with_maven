...
public class UFNCInjection1 implements IPocBase {
	...
	public Map info() {
		...
		info.put("name", "Ufnc SQL Injection1");
		info.put("location", "epp/detail/publishinfodetail.jsp?pk_message=1002A31000000000BS0X*");
		return info;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(new UFNCInjection1().verify(infodict));
	}
